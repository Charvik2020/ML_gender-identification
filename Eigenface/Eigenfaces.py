...
dirname="aligneddataset/Colored_class/"
...
dirname="aligneddataset/BW_class/"
count=0
...
wttraining=np.dot(eigenfaces,data.transpose()).transpose()			#size of weight for trainging data == SIZE(training X k)
...
print 'Predicted-male: ', male
print 'Total Female: ', testlabel.count('f')
print 'Predicted-Female: ', female
